  ...
  return (
    <div>
          ...
          return (
            <div key={order.id} className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
              <div className="flex justify-between items-start mb-4">
                <div>
                  <h3 className="font-semibold text-gray-800 dark:text-white">Pedido #{padId(order.orderNumber)}</h3>
      ...
      <ConfirmModal
        ...
        message={cancelConfirm ? `Tem certeza que deseja cancelar o Pedido #${padId(cancelConfirm.orderNumber)}? O cliente será notificado via WhatsApp.` : ''}
