...
import { FiHome, FiBriefcase, FiUsers, FiGrid, FiPackage, FiLayers, FiCpu, FiShoppingCart, FiLogOut, FiMoon, FiSun } from 'react-icons/fi'
...
export default function ClientLayout() {
  ...
  return (
    <div className="flex h-screen bg-gray-100 dark:bg-gray-900">
      {/* Sidebar */}
      <aside className="w-64 bg-green-700 dark:bg-gray-800 text-white flex flex-col">
        <div className="p-6 border-b border-green-600 dark:border-gray-700">
        ...
        <div className="p-4 border-t border-green-600 dark:border-gray-700">
          <div className="text-sm text-green-200 dark:text-gray-400 mb-3">{user?.name}</div>
